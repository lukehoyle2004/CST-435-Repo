...
never the raw tokens (the "store hashes, not raw payloads" invariant). The
fitted attention model lives in `run_artifacts` (not anon-readable).
...
# ---------------------------------------------------------------------------
# sequence_metadata  (hash + length + prediction; NO raw tokens)
# ---------------------------------------------------------------------------
